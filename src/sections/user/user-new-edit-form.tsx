...
export default function UserNewEditForm({ currentUser }: Props) {
  ...
  const defaultValues = {
    ...
    incasseren: currentUser?.incasseren || "",
    ...
    is_access_granted_social_media: currentUser?.is_access_granted_social_media || "",
    is_payment_termin_active: currentUser?.is_payment_termin_active || "",
    is_eligible_to_work_with: currentUser?.is_eligible_to_work_with || "",
    is_relation_user: currentUser?.is_relation_user || "",
    is_subscribed_newsletters: currentUser?.is_subscribed_newsletters || "",
    is_vat_document_printed: currentUser?.is_vat_document_printed || "",
    kvk: currentUser?.kvk || "",
    notify: currentUser?.notify || "",
    needs_electronic_invoice: currentUser?.needs_electronic_invoice || "",
